...
eps=${12}
    ...
    > logs/subs${subs_net}-${subs_chk}-tgt${target_net}-${target_chk}-seed${seed}-nvars${nvars}-gstd${gaussstd}-pgdsteps${pgd_steps}-pgdlr${pgd_lr}-eps${eps}-4800samples.log 2>&1 &

}

# runexp       subs_chk     subs_net      target_chk                                        target_net  cname               seed   gpu  nvars   gaussstd    steps    lr    eps
runexp     ckpt-%s-4800.t7  ResNet18      ckpt-%s-4800-dp0.000-droplayer0.000-seed1226.t7   ResNet18    centroids/init.pth  987123 0   4        0.0         20      0.05   4    
runexp     ckpt-%s-4800.t7  ResNet18      ckpt-%s-4800-dp0.000-droplayer0.000-seed1226.t7   ResNet18    centroids/init.pth  123847 1   4        0.0         20      0.05   4
runexp     ckpt-%s-4800.t7  ResNet18      ckpt-%s-4800-dp0.000-droplayer0.000-seed1226.t7   ResNet18    centroids/init.pth  543566 2   4        0.0         20      0.05   4
runexp     ckpt-%s-4800.t7  ResNet18      ckpt-%s-4800-dp0.000-droplayer0.000-seed1226.t7   ResNet18    centroids/init.pth  342545 3   4        0.0         20      0.05   4
